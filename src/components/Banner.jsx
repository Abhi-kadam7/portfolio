...
const Banner = () => {
  const [data] = useState({
    ...
    With expertise in front-end and back-end technologies, I focus on building user-friendly, high-performance, and scalable applications.
    Driven by curiosity and a commitment to quality, I strive to deliver innovative solutions and continuously enhance my skills.`,
  });
    ...
    >
      ...
      >
        <div className='w-full lg:w-2/3 space-y-5 text-center lg:text-left'>
          ...
          <motion.p 
            className="text-sm lg:text-lg opacity-90"
          ...
          >
            {[
              ...
              { href: 'https://www.linkedin.com/in/abhijit-kadam-15b1912b4', icon: 'fa-linkedin' },
              { href: 'https://wa.me/917767884217', icon: 'fa-square-whatsapp' },
              { href: 'https://github.com/your-github-username', icon: 'fa-github' },
            ].map((social, index) => (
              <motion.a
                key={index}
                href={social.href}
                ...
                className='cursor-pointer hover:bg-orange-600 px-3 py-3 w-11 h-10 rounded-full flex justify-center items-center bg-gray-700 shadow-lg'
